...
function Page() {
  ...
  return (
    <Layout
      nextUrl={
        "/stock-investing/analysis-method/framework/top-down-analysis/strategy-or-model"
      }
    >
      <PageHeader
        parentHeading="Stock Investing"
        childHeading="Goals and Approachs"
      ...
      <div className={styles.container}>
        <TopDownAnalysisSideNav activeHeadingId={1} activeSubheadingId={1.2} />
        <div>
