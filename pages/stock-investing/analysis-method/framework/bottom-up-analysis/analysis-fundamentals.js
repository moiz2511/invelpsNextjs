...
import TopDownAnalysisSideNav from "@/components/stockInvesting/analysisMethod/TopDownAnalysisSideNav";
import BottomUpAnalysisSideNav from "@/components/stockInvesting/analysisMethod/BottomUpAnalysisSideNav";
...
function Page() {
  ...
  return (
    <Layout
      nextUrl={
        "/stock-investing/analysis-method/framework/bottom-up-analysis/goals-and-approaches"
      }
    >
      <PageHeader
      ...
      <div className={styles.container}>
        <BottomUpAnalysisSideNav activeHeadingId={1} activeSubheadingId={1.1} />
        <div>
