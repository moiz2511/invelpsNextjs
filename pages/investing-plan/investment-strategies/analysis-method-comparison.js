...
function Index() {
  ...
  return (
    ...
    >
      <PageHeader
        parentHeading={
          <Link href="/investing-plan/investment-strategies/analysis-method-overview">
            Global Market Overview
          </Link>
        }
        childHeading="Sectors Overview and Comparsion"
                  ...
                  rows={[
                    {
                      sector: (
                        <Link
                          href="/investing-plan/investment-strategies/analysis-method-comparsion-industries"
                          style={{
                            color: "#1890ff",
                            whiteSpace: "nowrap",
                            cursor: "pointer",
